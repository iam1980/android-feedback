<ul class="nav nav-pills nav-stacked">
    ...
    <li class="<?php echo ($current == 'account_apiaccess') ? 'active' : ''; ?>"><?php echo anchor('account/account_apiaccess', "API Access"); ?></li>
    <li class="<?php echo ($current == 'account_library') ? 'active' : ''; ?>"><?php echo anchor('account/account_library', "Library"); ?></li>
</ul>